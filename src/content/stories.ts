...
export const stories: Story[] = [
  {
    ...
    excerpt:
      "Yui never needed sympathy. She needed a workplace built around ability instead of around exceptions, and once she had it, the accommodation stopped being remarkable.",
    featured: true,
    quote:
    ...
    body: [
      ...
      "Today Yui is not a story about someone who overcame. She is a story about a system that finally did its job. Her output speaks for itself, her team forgot there was ever anything to adjust, and the only thing that changed was the shape of the tools around her. That is the whole model: not helping a person fit a broken workplace, but fixing the workplace so ability can simply do its work.",
    ],
    image: {
  ...
  },
  {
    ...
    image: {
      ...
      alt: "Priya, a schoolgirl in uniform, standing confidently among her classmates in a bright classroom.",
    },
  },
];
